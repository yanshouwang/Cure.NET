...
namespace Screw.Core.ViewModels
{
    static class DeviceUtil
    {
        ...
        public static DeviceArgs GetArgs(short rssi, short vid, short pid, byte mid, string mac)
        {
            var key = GetKey(vid, pid, mid);
            ...
            return new DeviceArgs(category, rssi, vid, pid, mid, mac, communicationUUID, notifyUUID, writeUUID);
        }
    }
}
