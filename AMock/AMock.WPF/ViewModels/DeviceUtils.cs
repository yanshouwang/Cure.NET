...
namespace AMock.WPF.ViewModels
{
    static class DeviceUtils
    {
        ...
        public static DeviceArgs GetArgs(ulong address, short rssi, short vid, short pid, byte mid, string mac)
        {
            var key = GetKey(vid, pid, mid);
            ...
            return new DeviceArgs(category, address, rssi, vid, pid, mid, mac, communicationUUID, notifyUUID, writeUUID);
        }
    }
}
